...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        Building software that solves real-world problems through mobile
        applications, web development, and workflow automation.
      </p>
      ...
      >
        <style>{`@keyframes float{0%,100%{transform:translateX(-50%) translateY(0);}50%{transform:translateX(-50%) translateY(6px);}}`}</style>
